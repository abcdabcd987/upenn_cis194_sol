...
ex7Tests = [ testF1 "solve test" solve
             [ ([Green, Red, Blue, Orange],
                [Move [Red,Red,Red,Red] 1 0,Move [Green,Green,Green,Red] 1 1,Move [Blue,Green,Red,Blue] 0 3,Move [Red,Blue,Green,Yellow] 0 3,Move [Green,Red,Blue,Orange] 4 0])
             , ([Red, Red, Red, Red, Red],
                [Move [Red,Red,Red,Red,Red] 5 0])
             ]
           ]
